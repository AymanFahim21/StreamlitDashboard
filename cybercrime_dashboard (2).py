...
def main() -> None:
    ...
    # Replace any missing loss values with zero for a cleaner display.  Without this,
    # Streamlit will show blank cells for states that are not in the top‑10 list.
